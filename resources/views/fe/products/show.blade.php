                            ...
                            <div class="row">
                                <div class="col-sm-3 col-lg-3">
                                    <div class="owl-thumbs" data-slider-id="1">
                                        <div class="item owl-thumb-item">
                                            <div class="top-img">
                                                <img src="{{ asset('fe/assets/images/products/product-details1.png') }}" alt="Product">
                                            </div>
                                        </div>
                                        <div class="item owl-thumb-item">
                                            <div class="top-img">
                                                <img src="{{ asset('fe/assets/images/products/product-details2.png') }}" alt="Product">
                                            </div>
                                        </div>
                                        <div class="item owl-thumb-item">
                                            <div class="top-img">
                                                <img src="{{ asset('fe/assets/images/products/product-details3.png') }}" alt="Product">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-9 col-lg-9">
                                    <div class="image-slides owl-carousel owl-theme" data-slider-id="1">
                                        <div class="item">
                                            <div class="top-img">
                                                <img src="{{ asset('fe/assets/images/products/product-details4.png') }}" alt="Product">
                                            </div>
                                        </div>
                                        <div class="top-img">
                                            <img src="{{ asset('fe/assets/images/products/product-details5.png') }}" alt="Product">
                                        </div>
                                        <div class="top-img">
                                            <img src="{{ asset('fe/assets/images/products/product-details6.png') }}" alt="Product">
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                        <div class="bottom-description">
                            ...
                            <ul>
                                ...
                                <li><span></span> Eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua</li>
                                <li><span></span> At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren</li>
                                <li><span></span> No sea takimata sanctus est Lorem ipsum dolor sit amet</li>
                                <li><span></span> Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor</li>
                            </ul>
                        </div>
                    </div>
                </div>
